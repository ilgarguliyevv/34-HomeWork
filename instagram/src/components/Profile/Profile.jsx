          ...
          <div className="container">
            <div className="profile">
              ...
              <div className="profile-user-settings">
                <h1 className="profile-user-name">guliyevv_i</h1>
              ...
              <div className="profile-stats">
                <ul>
                  ...
                  <li>
                    <span className="profile-stat-count">216</span> followers
                  </li>
                  <li>
                    <span className="profile-stat-count">307</span> following
                  </li>
                </ul>
              </div>
              <div className="profile-bio">
                <p>
                  <span className="profile-real-name">İlqar Quliyev</span>
                  👨🏻‍💻
                </p>
              </div>
            </div>
